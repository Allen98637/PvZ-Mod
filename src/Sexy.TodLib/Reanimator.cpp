...
ReanimationParams gLawnReanimationArray[ReanimationType::NUM_REANIMS] = {
	{ .mReanimationType = ReanimationType::REANIM_LOADBAR_SPROUT,             .mReanimFileName = "reanim/LoadBar_sprout.reanim",                    1 },
	{ .mReanimationType = ReanimationType::REANIM_LOADBAR_ZOMBIEHEAD,         .mReanimFileName = "reanim/LoadBar_Zombiehead.reanim",                1 },
	{ .mReanimationType = ReanimationType::REANIM_SODROLL,                    .mReanimFileName = "reanim/SodRoll.reanim",                           0 },
	{ .mReanimationType = ReanimationType::REANIM_FINAL_WAVE,                 .mReanimFileName = "reanim/FinalWave.reanim",                         1 },
	{ .mReanimationType = ReanimationType::REANIM_PEASHOOTER,                 .mReanimFileName = "reanim/PeaShooterSingle.reanim",                  0 },
	{ .mReanimationType = ReanimationType::REANIM_WALLNUT,                    .mReanimFileName = "reanim/Wallnut.reanim",                           0 },
	{ .mReanimationType = ReanimationType::REANIM_LILYPAD,                    .mReanimFileName = "reanim/Lilypad.reanim",                           0 },
	{ .mReanimationType = ReanimationType::REANIM_SUNFLOWER,                  .mReanimFileName = "reanim/SunFlower.reanim",                         0 },
	{ .mReanimationType = ReanimationType::REANIM_LAWNMOWER,                  .mReanimFileName = "reanim/LawnMower.reanim",                         0 },
	{ .mReanimationType = ReanimationType::REANIM_READYSETPLANT,              .mReanimFileName = "reanim/StartReadySetPlant.reanim",                1 },
	{ .mReanimationType = ReanimationType::REANIM_CHERRYBOMB,                 .mReanimFileName = "reanim/CherryBomb.reanim",                        0 },
	{ .mReanimationType = ReanimationType::REANIM_SQUASH,                     .mReanimFileName = "reanim/Squash.reanim",                            0 },
	{ .mReanimationType = ReanimationType::REANIM_DOOMSHROOM,                 .mReanimFileName = "reanim/DoomShroom.reanim",                        0 },
	{ .mReanimationType = ReanimationType::REANIM_SNOWPEA,                    .mReanimFileName = "reanim/SnowPea.reanim",                           0 },
	{ .mReanimationType = ReanimationType::REANIM_REPEATER,                   .mReanimFileName = "reanim/PeaShooter.reanim",                        0 },
	{ .mReanimationType = ReanimationType::REANIM_SUNSHROOM,                  .mReanimFileName = "reanim/SunShroom.reanim",                         0 },
	{ .mReanimationType = ReanimationType::REANIM_TALLNUT,                    .mReanimFileName = "reanim/Tallnut.reanim",                           0 },
	{ .mReanimationType = ReanimationType::REANIM_FUMESHROOM,                 .mReanimFileName = "reanim/Fumeshroom.reanim",                        0 },
	{ .mReanimationType = ReanimationType::REANIM_PUFFSHROOM,                 .mReanimFileName = "reanim/Puffshroom.reanim",                        0 },
	{ .mReanimationType = ReanimationType::REANIM_HYPNOSHROOM,                .mReanimFileName = "reanim/Hypnoshroom.reanim",                       0 },
	{ .mReanimationType = ReanimationType::REANIM_CHOMPER,                    .mReanimFileName = "reanim/Chomper.reanim",                           0 },
	{ .mReanimationType = ReanimationType::REANIM_ZOMBIE,                     .mReanimFileName = "reanim/Zombie.reanim",                            0 },
	{ .mReanimationType = ReanimationType::REANIM_SUN,                        .mReanimFileName = "reanim/Sun.reanim",                               0 },
	{ .mReanimationType = ReanimationType::REANIM_POTATOMINE,                 .mReanimFileName = "reanim/PotatoMine.reanim",                        0 },
	{ .mReanimationType = ReanimationType::REANIM_SPIKEWEED,                  .mReanimFileName = "reanim/Caltrop.reanim",                           0 },
	{ .mReanimationType = ReanimationType::REANIM_SPIKEROCK,                  .mReanimFileName = "reanim/SpikeRock.reanim",                         0 },
	{ .mReanimationType = ReanimationType::REANIM_THREEPEATER,                .mReanimFileName = "reanim/ThreePeater.reanim",                       0 },
	{ .mReanimationType = ReanimationType::REANIM_MARIGOLD,                   .mReanimFileName = "reanim/Marigold.reanim",                          0 },
	{ .mReanimationType = ReanimationType::REANIM_ICESHROOM,                  .mReanimFileName = "reanim/IceShroom.reanim",                         0 },
	{ .mReanimationType = ReanimationType::REANIM_ZOMBIE_FOOTBALL,            .mReanimFileName = "reanim/Zombie_football.reanim",                   0 },
	{ .mReanimationType = ReanimationType::REANIM_ZOMBIE_FOOTBALL_GIGA,       .mReanimFileName = "reanim/Zombie_football_giga.reanim",                   0 },
	{ .mReanimationType = ReanimationType::REANIM_ZOMBIE_NEWSPAPER,           .mReanimFileName = "reanim/Zombie_paper.reanim",                      0 },
	{ .mReanimationType = ReanimationType::REANIM_ZOMBIE_ZAMBONI,             .mReanimFileName = "reanim/Zombie_zamboni.reanim",                    0 },
	{ .mReanimationType = ReanimationType::REANIM_SPLASH,                     .mReanimFileName = "reanim/splash.reanim",                            0 },
	{ .mReanimationType = ReanimationType::REANIM_JALAPENO,                   .mReanimFileName = "reanim/Jalapeno.reanim",                          0 },
	{ .mReanimationType = ReanimationType::REANIM_JALAPENO_FIRE,              .mReanimFileName = "reanim/fire.reanim",                              0 },
	{ .mReanimationType = ReanimationType::REANIM_COIN_SILVER,                .mReanimFileName = "reanim/Coin_silver.reanim",                       0 },
	{ .mReanimationType = ReanimationType::REANIM_ZOMBIE_CHARRED,             .mReanimFileName = "reanim/Zombie_charred.reanim",                    0 },
	{ .mReanimationType = ReanimationType::REANIM_ZOMBIE_CHARRED_IMP,         .mReanimFileName = "reanim/Zombie_charred_imp.reanim",                0 },
	{ .mReanimationType = ReanimationType::REANIM_ZOMBIE_CHARRED_DIGGER,      .mReanimFileName = "reanim/Zombie_charred_digger.reanim",             0 },
	{ .mReanimationType = ReanimationType::REANIM_ZOMBIE_CHARRED_ZAMBONI,     .mReanimFileName = "reanim/Zombie_charred_zamboni.reanim",            0 },
	{ .mReanimationType = ReanimationType::REANIM_ZOMBIE_CHARRED_CATAPULT,    .mReanimFileName = "reanim/Zombie_charred_catapult.reanim",           0 },
	{ .mReanimationType = ReanimationType::REANIM_ZOMBIE_CHARRED_GARGANTUAR,  .mReanimFileName = "reanim/Zombie_charred_gargantuar.reanim",         0 },
	{ .mReanimationType = ReanimationType::REANIM_SCRAREYSHROOM,              .mReanimFileName = "reanim/ScaredyShroom.reanim",                     0 },
	{ .mReanimationType = ReanimationType::REANIM_PUMPKIN,                    .mReanimFileName = "reanim/Pumpkin.reanim",                           0 },
	{ .mReanimationType = ReanimationType::REANIM_PUMPKIN_STAIR,              .mReanimFileName = "reanim/Pumpkin_stair.reanim",                     0 },
	{ .mReanimationType = ReanimationType::REANIM_PLANTERN,                   .mReanimFileName = "reanim/Plantern.reanim",                          0 },
	{ .mReanimationType = ReanimationType::REANIM_TORCHWOOD,                  .mReanimFileName = "reanim/Torchwood.reanim",                         0 },
	{ .mReanimationType = ReanimationType::REANIM_SPLITPEA,                   .mReanimFileName = "reanim/SplitPea.reanim",                          0 },
	{ .mReanimationType = ReanimationType::REANIM_SEASHROOM,                  .mReanimFileName = "reanim/SeaShroom.reanim",                         0 },
	{ .mReanimationType = ReanimationType::REANIM_BLOVER,                     .mReanimFileName = "reanim/Blover.reanim",                            0 },
	{ .mReanimationType = ReanimationType::REANIM_FLOWER_POT,                 .mReanimFileName = "reanim/Pot.reanim",                               0 },
	{ .mReanimationType = ReanimationType::REANIM_CACTUS,                     .mReanimFileName = "reanim/Cactus.reanim",                            0 },
	{ .mReanimationType = ReanimationType::REANIM_DANCER,                     .mReanimFileName = "reanim/Zombie_disco.reanim",						0 }, // @Patoke: GOTY has different reanim name
	{ .mReanimationType = ReanimationType::REANIM_TANGLEKELP,                 .mReanimFileName = "reanim/Tanglekelp.reanim",                        0 },
	{ .mReanimationType = ReanimationType::REANIM_STARFRUIT,                  .mReanimFileName = "reanim/Starfruit.reanim",                         0 },
	{ .mReanimationType = ReanimationType::REANIM_POLEVAULTER,                .mReanimFileName = "reanim/Zombie_polevaulter.reanim",                0 },
	{ .mReanimationType = ReanimationType::REANIM_BALLOON,                    .mReanimFileName = "reanim/Zombie_balloon.reanim",                    0 },
	{ .mReanimationType = ReanimationType::REANIM_GARGANTUAR,                 .mReanimFileName = "reanim/Zombie_gargantuar.reanim",                 0 },
	{ .mReanimationType = ReanimationType::REANIM_IMP,                        .mReanimFileName = "reanim/Zombie_imp.reanim",                        0 },
	{ .mReanimationType = ReanimationType::REANIM_DIGGER,                     .mReanimFileName = "reanim/Zombie_digger.reanim",                     0 },
	{ .mReanimationType = ReanimationType::REANIM_DIGGER_DIRT,                .mReanimFileName = "reanim/Digger_rising_dirt.reanim",                0 },
	{ .mReanimationType = ReanimationType::REANIM_ZOMBIE_DOLPHINRIDER,        .mReanimFileName = "reanim/Zombie_dolphinrider.reanim",               0 },
	{ .mReanimationType = ReanimationType::REANIM_POGO,                       .mReanimFileName = "reanim/Zombie_pogo.reanim",                       0 },
	{ .mReanimationType = ReanimationType::REANIM_BACKUP_DANCER,              .mReanimFileName = "reanim/Zombie_backup.reanim",                     0 }, // @Patoke: GOTY has different reanim name
	{ .mReanimationType = ReanimationType::REANIM_BOBSLED,                    .mReanimFileName = "reanim/Zombie_bobsled.reanim",                    0 },
	{ .mReanimationType = ReanimationType::REANIM_JACKINTHEBOX,               .mReanimFileName = "reanim/Zombie_jackbox.reanim",                    0 },
	{ .mReanimationType = ReanimationType::REANIM_SNORKEL,                    .mReanimFileName = "reanim/Zombie_snorkle.reanim",                    0 },
	{ .mReanimationType = ReanimationType::REANIM_BUNGEE,                     .mReanimFileName = "reanim/Zombie_bungi.reanim",                      0 },
	{ .mReanimationType = ReanimationType::REANIM_CATAPULT,                   .mReanimFileName = "reanim/Zombie_catapult.reanim",                   0 },
	{ .mReanimationType = ReanimationType::REANIM_LADDER,                     .mReanimFileName = "reanim/Zombie_ladder.reanim",                     0 },
	{ .mReanimationType = ReanimationType::REANIM_PUFF,                       .mReanimFileName = "reanim/Puff.reanim",                              0 },
	{ .mReanimationType = ReanimationType::REANIM_SLEEPING,                   .mReanimFileName = "reanim/Z.reanim",                                 0 },
	{ .mReanimationType = ReanimationType::REANIM_GRAVE_BUSTER,               .mReanimFileName = "reanim/Gravebuster.reanim",                       0 },
	{ .mReanimationType = ReanimationType::REANIM_ZOMBIES_WON,                .mReanimFileName = "reanim/ZombiesWon.reanim",                        1 },
	{ .mReanimationType = ReanimationType::REANIM_MAGNETSHROOM,               .mReanimFileName = "reanim/Magnetshroom.reanim",                      0 },
	{ .mReanimationType = ReanimationType::REANIM_BOSS,                       .mReanimFileName = "reanim/Zombie_boss.reanim",                       0 },
	{ .mReanimationType = ReanimationType::REANIM_CABBAGEPULT,                .mReanimFileName = "reanim/Cabbagepult.reanim",                       0 },
	{ .mReanimationType = ReanimationType::REANIM_KERNELPULT,                 .mReanimFileName = "reanim/Cornpult.reanim",                          0 },
	{ .mReanimationType = ReanimationType::REANIM_MELONPULT,                  .mReanimFileName = "reanim/Melonpult.reanim",                         0 },
	{ .mReanimationType = ReanimationType::REANIM_COFFEEBEAN,                 .mReanimFileName = "reanim/Coffeebean.reanim",                        1 },
	{ .mReanimationType = ReanimationType::REANIM_UMBRELLALEAF,               .mReanimFileName = "reanim/Umbrellaleaf.reanim",                      0 },
	{ .mReanimationType = ReanimationType::REANIM_GATLINGPEA,                 .mReanimFileName = "reanim/GatlingPea.reanim",                        0 },
	{ .mReanimationType = ReanimationType::REANIM_CATTAIL,                    .mReanimFileName = "reanim/Cattail.reanim",                           0 },
	{ .mReanimationType = ReanimationType::REANIM_GLOOMSHROOM,                .mReanimFileName = "reanim/GloomShroom.reanim",                       0 },
	{ .mReanimationType = ReanimationType::REANIM_BOSS_ICEBALL,               .mReanimFileName = "reanim/Zombie_boss_iceball.reanim",               1 },
	{ .mReanimationType = ReanimationType::REANIM_BOSS_FIREBALL,              .mReanimFileName = "reanim/Zombie_boss_fireball.reanim",              1 },
	{ .mReanimationType = ReanimationType::REANIM_COBCANNON,                  .mReanimFileName = "reanim/CobCannon.reanim",                         0 },
	{ .mReanimationType = ReanimationType::REANIM_GARLIC,                     .mReanimFileName = "reanim/Garlic.reanim",                            0 },
	{ .mReanimationType = ReanimationType::REANIM_GOLD_MAGNET,                .mReanimFileName = "reanim/GoldMagnet.reanim",                        0 },
	{ .mReanimationType = ReanimationType::REANIM_WINTER_MELON,               .mReanimFileName = "reanim/WinterMelon.reanim",                       0 },
	{ .mReanimationType = ReanimationType::REANIM_TWIN_SUNFLOWER,             .mReanimFileName = "reanim/TwinSunflower.reanim",                     0 },
	{ .mReanimationType = ReanimationType::REANIM_POOL_CLEANER,               .mReanimFileName = "reanim/PoolCleaner.reanim",                       0 },
	{ .mReanimationType = ReanimationType::REANIM_ROOF_CLEANER,               .mReanimFileName = "reanim/RoofCleaner.reanim",                       0 },
	{ .mReanimationType = ReanimationType::REANIM_FIRE_PEA,                   .mReanimFileName = "reanim/FirePea.reanim",                           0 },
	{ .mReanimationType = ReanimationType::REANIM_IMITATER,                   .mReanimFileName = "reanim/Imitater.reanim",                          0 },
	{ .mReanimationType = ReanimationType::REANIM_YETI,                       .mReanimFileName = "reanim/Zombie_yeti.reanim",                       0 },
	{ .mReanimationType = ReanimationType::REANIM_BOSS_DRIVER,                .mReanimFileName = "reanim/Zombie_Boss_driver.reanim",                0 },
	{ .mReanimationType = ReanimationType::REANIM_LAWN_MOWERED_ZOMBIE,        .mReanimFileName = "reanim/LawnMoweredZombie.reanim",                 0 },
	{ .mReanimationType = ReanimationType::REANIM_CRAZY_DAVE,                 .mReanimFileName = "reanim/CrazyDave.reanim",                         1 },
	{ .mReanimationType = ReanimationType::REANIM_TEXT_FADE_ON,               .mReanimFileName = "reanim/TextFadeOn.reanim",                        0 },
	{ .mReanimationType = ReanimationType::REANIM_HAMMER,                     .mReanimFileName = "reanim/Hammer.reanim",                            0 },
	{ .mReanimationType = ReanimationType::REANIM_SLOT_MACHINE_HANDLE,        .mReanimFileName = "reanim/SlotMachine.reanim",                       0 },
	{ .mReanimationType = ReanimationType::REANIM_CREDITS_FOOTBALL,           .mReanimFileName = "reanim/Credits_Football.reanim",                  1 },
	{ .mReanimationType = ReanimationType::REANIM_CREDITS_JACKBOX,            .mReanimFileName = "reanim/Credits_Jackbox.reanim",                   1 },
	{ .mReanimationType = ReanimationType::REANIM_SELECTOR_SCREEN,            .mReanimFileName = "reanim/SelectorScreen.reanim",                    3 },
	{ .mReanimationType = ReanimationType::REANIM_PORTAL_CIRCLE,              .mReanimFileName = "reanim/Portal_Circle.reanim",                     0 },
	{ .mReanimationType = ReanimationType::REANIM_PORTAL_SQUARE,              .mReanimFileName = "reanim/Portal_Square.reanim",                     0 },
	{ .mReanimationType = ReanimationType::REANIM_ZENGARDEN_SPROUT,           .mReanimFileName = "reanim/ZenGarden_sprout.reanim",                  0 },
	{ .mReanimationType = ReanimationType::REANIM_ZENGARDEN_WATERINGCAN,      .mReanimFileName = "reanim/ZenGarden_wateringcan.reanim",             1 },
	{ .mReanimationType = ReanimationType::REANIM_ZENGARDEN_FERTILIZER,       .mReanimFileName = "reanim/ZenGarden_fertilizer.reanim",              1 },
	{ .mReanimationType = ReanimationType::REANIM_ZENGARDEN_BUGSPRAY,         .mReanimFileName = "reanim/ZenGarden_bugspray.reanim",                1 },
	{ .mReanimationType = ReanimationType::REANIM_ZENGARDEN_PHONOGRAPH,       .mReanimFileName = "reanim/ZenGarden_phonograph.reanim",              1 },
	{ .mReanimationType = ReanimationType::REANIM_DIAMOND,                    .mReanimFileName = "reanim/Diamond.reanim",                           0 },
	{ .mReanimationType = ReanimationType::REANIM_ZOMBIE_HAND,                .mReanimFileName = "reanim/Zombie_hand.reanim",                       1 },
	{ .mReanimationType = ReanimationType::REANIM_STINKY,                     .mReanimFileName = "reanim/Stinky.reanim",                            0 },
	{ .mReanimationType = ReanimationType::REANIM_RAKE,                       .mReanimFileName = "reanim/Rake.reanim",                              0 },
	{ .mReanimationType = ReanimationType::REANIM_RAIN_CIRCLE,                .mReanimFileName = "reanim/Rain_circle.reanim",                       0 },
	{ .mReanimationType = ReanimationType::REANIM_RAIN_SPLASH,                .mReanimFileName = "reanim/Rain_splash.reanim",                       0 },
	{ .mReanimationType = ReanimationType::REANIM_ZOMBIE_SURPRISE,            .mReanimFileName = "reanim/Zombie_surprise.reanim",                   0 },
	{ .mReanimationType = ReanimationType::REANIM_COIN_GOLD,                  .mReanimFileName = "reanim/Coin_gold.reanim",                         0 },
	{ .mReanimationType = ReanimationType::REANIM_TREEOFWISDOM,               .mReanimFileName = "reanim/TreeOfWisdom.reanim",                      1 },
	{ .mReanimationType = ReanimationType::REANIM_TREEOFWISDOM_CLOUDS,        .mReanimFileName = "reanim/TreeOfWisdomClouds.reanim",                1 },
	{ .mReanimationType = ReanimationType::REANIM_TREEOFWISDOM_TREEFOOD,      .mReanimFileName = "reanim/TreeFood.reanim",                          1 },
	{ .mReanimationType = ReanimationType::REANIM_CREDITS_MAIN,               .mReanimFileName = "reanim/Credits_Main.reanim",                      3 },
	{ .mReanimationType = ReanimationType::REANIM_CREDITS_MAIN2,              .mReanimFileName = "reanim/Credits_Main2.reanim",                     3 },
	{ .mReanimationType = ReanimationType::REANIM_CREDITS_MAIN3,              .mReanimFileName = "reanim/Credits_Main3.reanim",                     3 },
	{ .mReanimationType = ReanimationType::REANIM_ZOMBIE_CREDITS_DANCE,       .mReanimFileName = "reanim/Zombie_credits_dance.reanim",              0 },
	{ .mReanimationType = ReanimationType::REANIM_CREDITS_STAGE,              .mReanimFileName = "reanim/Credits_stage.reanim",                     1 },
	{ .mReanimationType = ReanimationType::REANIM_CREDITS_BIGBRAIN,           .mReanimFileName = "reanim/Credits_BigBrain.reanim",                  1 },
	{ .mReanimationType = ReanimationType::REANIM_CREDITS_FLOWER_PETALS,      .mReanimFileName = "reanim/Credits_Flower_petals.reanim",             1 },
	{ .mReanimationType = ReanimationType::REANIM_CREDITS_INFANTRY,           .mReanimFileName = "reanim/Credits_Infantry.reanim",                  1 },
	{ .mReanimationType = ReanimationType::REANIM_CREDITS_THROAT,             .mReanimFileName = "reanim/Credits_Throat.reanim",                    1 },
	{ .mReanimationType = ReanimationType::REANIM_CREDITS_CRAZYDAVE,          .mReanimFileName = "reanim/Credits_CrazyDave.reanim",                 1 },
	{ .mReanimationType = ReanimationType::REANIM_CREDITS_BOSSDANCE,          .mReanimFileName = "reanim/Credits_Bossdance.reanim",                 1 },
	{ .mReanimationType = ReanimationType::REANIM_ZOMBIE_CREDITS_SCREEN_DOOR, .mReanimFileName = "reanim/Zombie_Credits_Screendoor.reanim",         1 },
	{ .mReanimationType = ReanimationType::REANIM_ZOMBIE_CREDITS_CONEHEAD,    .mReanimFileName = "reanim/Zombie_Credits_Conehead.reanim",           1 },
	{ .mReanimationType = ReanimationType::REANIM_CREDITS_ZOMBIEARMY1,        .mReanimFileName = "reanim/Credits_ZombieArmy1.reanim",               1 },
	{ .mReanimationType = ReanimationType::REANIM_CREDITS_ZOMBIEARMY2,        .mReanimFileName = "reanim/Credits_ZombieArmy2.reanim",               1 },
	{ .mReanimationType = ReanimationType::REANIM_CREDITS_TOMBSTONES,         .mReanimFileName = "reanim/Credits_Tombstones.reanim",                1 },
	{ .mReanimationType = ReanimationType::REANIM_CREDITS_SOLARPOWER,         .mReanimFileName = "reanim/Credits_SolarPower.reanim",                1 },
	{ .mReanimationType = ReanimationType::REANIM_CREDITS_ANYHOUR,            .mReanimFileName = "reanim/Credits_Anyhour.reanim",                   3 },
	{ .mReanimationType = ReanimationType::REANIM_CREDITS_WEARETHEUNDEAD,     .mReanimFileName = "reanim/Credits_WeAreTheUndead.reanim",            1 },
	{ .mReanimationType = ReanimationType::REANIM_CREDITS_DISCOLIGHTS,        .mReanimFileName = "reanim/Credits_DiscoLights.reanim",               1 },
	{ .mReanimationType = ReanimationType::REANIM_FLAG,                       .mReanimFileName = "reanim/Zombie_FlagPole.reanim",                   0 },
	{ .mReanimationType = ReanimationType::REANIM_WATER_POT,               	  .mReanimFileName = "reanim/pot_water.reanim",                     0 },
	{ .mReanimationType = ReanimationType::REANIM_JACKSON,                    .mReanimFileName = "reanim/Zombie_Jackson.reanim",               0 },
	{ .mReanimationType = ReanimationType::REANIM_ZOMBIE_DANCER,              .mReanimFileName = "reanim/Zombie_dancer.reanim",               0 },
	{ .mReanimationType = ReanimationType::REANIM_BLUEOON,                    .mReanimFileName = "reanim/Zombie_blueoon.reanim",                    0 },
};
...
// (*def, eax = string& fileName)  //esp -= 0x4

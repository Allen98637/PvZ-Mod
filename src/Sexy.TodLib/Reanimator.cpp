...
ReanimationParams gLawnReanimationArray[ReanimationType::NUM_REANIMS] = {
	...
	{ .mReanimationType = ReanimationType::REANIM_ZOMBIE_FOOTBALL_GIGA,       .mReanimFileName = "reanim/Zombie_football_giga.reanim",              .mReanimParamFlags = 0 },
	...
	{ .mReanimationType = ReanimationType::REANIM_PUMPKIN_STAIR,              .mReanimFileName = "reanim/Pumpkin_stair.reanim",                     .mReanimParamFlags = 0 },
	...
	{ .mReanimationType = ReanimationType::REANIM_DANCER,                     .mReanimFileName = "reanim/Zombie_disco.reanim",						.mReanimParamFlags = 0 }, // @Patoke: GOTY has different reanim name
	...
	{ .mReanimationType = ReanimationType::REANIM_BACKUP_DANCER,              .mReanimFileName = "reanim/Zombie_backup.reanim",                     .mReanimParamFlags = 0 }, // @Patoke: GOTY has different reanim name
	...
	{ .mReanimationType = ReanimationType::REANIM_WATER_POT,               	  .mReanimFileName = "reanim/pot_water.reanim",                     .mReanimParamFlags = 0 },
	{ .mReanimationType = ReanimationType::REANIM_JACKSON,                    .mReanimFileName = "reanim/Zombie_Jackson.reanim",               .mReanimParamFlags = 0 },
	{ .mReanimationType = ReanimationType::REANIM_ZOMBIE_DANCER,              .mReanimFileName = "reanim/Zombie_dancer.reanim",               .mReanimParamFlags = 0 },
	{ .mReanimationType = ReanimationType::REANIM_BLUEOON,                    .mReanimFileName = "reanim/Zombie_blueoon.reanim",                   .mReanimParamFlags = 0 },
};

...
constinit const ZombieDefinition gZombieDefs[NUM_ZOMBIE_TYPES] = {
    ...
    { .mZombieType = ZOMBIE_PEA_HEAD,          .mReanimationType = REANIM_ZOMBIE,              .mZombieValue = 1,      .mStartingLevel = -1,     .mFirstAllowedWave = 1,      .mPickWeight = 4000,   .mZombieName = "ZOMBIE" },
    { .mZombieType = ZOMBIE_WALLNUT_HEAD,      .mReanimationType = REANIM_ZOMBIE,              .mZombieValue = 4,      .mStartingLevel = -1,     .mFirstAllowedWave = 1,      .mPickWeight = 3000,   .mZombieName = "ZOMBIE" },
    { .mZombieType = ZOMBIE_JALAPENO_HEAD,     .mReanimationType = REANIM_ZOMBIE,              .mZombieValue = 3,      .mStartingLevel = -1,     .mFirstAllowedWave = 10,     .mPickWeight = 1000,   .mZombieName = "ZOMBIE" },
    { .mZombieType = ZOMBIE_GATLING_HEAD,      .mReanimationType = REANIM_ZOMBIE,              .mZombieValue = 3,      .mStartingLevel = -1,     .mFirstAllowedWave = 10,     .mPickWeight = 2000,   .mZombieName = "ZOMBIE" },
    { .mZombieType = ZOMBIE_SQUASH_HEAD,       .mReanimationType = REANIM_ZOMBIE,              .mZombieValue = 3,      .mStartingLevel = -1,     .mFirstAllowedWave = 10,     .mPickWeight = 2000,   .mZombieName = "ZOMBIE" },
    { .mZombieType = ZOMBIE_TALLNUT_HEAD,      .mReanimationType = REANIM_ZOMBIE,              .mZombieValue = 4,      .mStartingLevel = -1,     .mFirstAllowedWave = 10,     .mPickWeight = 2000,   .mZombieName = "ZOMBIE" },
    { .mZombieType = ZOMBIE_REDEYE_GARGANTUAR, .mReanimationType = REANIM_GARGANTUAR,          .mZombieValue = 10,     .mStartingLevel = 93,     .mFirstAllowedWave = 15,     .mPickWeight = 6000,   .mZombieName = "REDEYED_GARGANTUAR" },
    { .mZombieType = ZOMBIE_GIGA_FOOTBALL,     .mReanimationType = REANIM_ZOMBIE_FOOTBALL_GIGA,.mZombieValue = 10,     .mStartingLevel = 56,     .mFirstAllowedWave = 15,     .mPickWeight = 4000,   .mZombieName = "GIGA_FOOTBALL_ZOMBIE" },
    { .mZombieType = ZOMBIE_DOOR_PAIL,         .mReanimationType = REANIM_ZOMBIE,              .mZombieValue = 5,      .mStartingLevel = 51,     .mFirstAllowedWave = 7,      .mPickWeight = 4000,   .mZombieName = "DOOR_PAIL_ZOMBIE" },
    { .mZombieType = ZOMBIE_JACKSON,           .mReanimationType = REANIM_JACKSON,             .mZombieValue = 10,     .mStartingLevel = 61,     .mFirstAllowedWave = 15,     .mPickWeight = 4000,   .mZombieName = "JACKSON_ZOMBIE" },
    { .mZombieType = ZOMBIE_JACKSON_DANCER,    .mReanimationType = REANIM_ZOMBIE_DANCER,       .mZombieValue = 1,      .mStartingLevel = 61,     .mFirstAllowedWave = 1,      .mPickWeight = 0,      .mZombieName = "ZOMBIE_JACKSON_DANCER" },
    { .mZombieType = ZOMBIE_BLUEOON,           .mReanimationType = REANIM_BLUEOON,             .mZombieValue = 5,      .mStartingLevel = 71,     .mFirstAllowedWave = 15,     .mPickWeight = 3000,   .mZombieName = "BLUEOON_ZOMBIE" },
    { .mZombieType = ZOMBIE_UMBRELLA_HEAD,     .mReanimationType = REANIM_ZOMBIE,              .mZombieValue = 3,      .mStartingLevel = -1,     .mFirstAllowedWave = 10,     .mPickWeight = 3000,   .mZombieName = "ZOMBIE" },
    { .mZombieType = ZOMBIE_CABBAGE_HEAD,      .mReanimationType = REANIM_ZOMBIE,              .mZombieValue = 1,      .mStartingLevel = -1,     .mFirstAllowedWave = 1,      .mPickWeight = 4000,   .mZombieName = "ZOMBIE" },
    { .mZombieType = ZOMBIE_MELON_HEAD,        .mReanimationType = REANIM_ZOMBIE,              .mZombieValue = 3,      .mStartingLevel = -1,     .mFirstAllowedWave = 5,      .mPickWeight = 3000,   .mZombieName = "ZOMBIE" },
    { .mZombieType = ZOMBIE_SNOWPEA_HEAD,      .mReanimationType = REANIM_ZOMBIE,              .mZombieValue = 3,      .mStartingLevel = -1,     .mFirstAllowedWave = 5,      .mPickWeight = 3000,   .mZombieName = "ZOMBIE" },
    { .mZombieType = ZOMBIE_HYPNO_HEAD,        .mReanimationType = REANIM_ZOMBIE,              .mZombieValue = 4,      .mStartingLevel = -1,     .mFirstAllowedWave = 10,     .mPickWeight = 3000,   .mZombieName = "ZOMBIE" },
    { .mZombieType = ZOMBIE_WINTERMELON_HEAD,  .mReanimationType = REANIM_ZOMBIE,              .mZombieValue = 5,      .mStartingLevel = -1,     .mFirstAllowedWave = 10,     .mPickWeight = 3000,   .mZombieName = "ZOMBIE" },
};
...
void Zombie::ZombieInitialize(int theRow, ZombieType theType, bool theVariant, Zombie* theParentZombie, int theFromWave)
{
    ...
    mZombotomyState = PlantState::STATE_NOTREADY;
    mZombotomyStateCountdown = 0;
    mPhaseCounter = 0;
    mPhaseCounter2 = 0;
    mHitUmbrella = false;
    mDroppedLoot = false;
    ...
    case ZombieType::ZOMBIE_FLAG:
    {
        ...
        if(!mApp->IsAdventureMode() || mApp->mPlayerInfo->mFinishedAdventure > 0){
            int ttt = Rand(11);
            if(ttt <= 2){
                ReanimShowPrefix("anim_bucket", RENDER_GROUP_NORMAL);
                ReanimShowPrefix("anim_hair", RENDER_GROUP_HIDDEN);
    ...
    case ZombieType::ZOMBIE_JACKSON_DANCER:{
        ...
        if ((mBoard && mBoard->mPlantRow[mRow] == PlantRowType::PLANTROW_POOL && mFromWave != Zombie::ZOMBIE_WAVE_CUTSCENE))
        {
    ...
    case ZombieType::ZOMBIE_BOSS:
        ...
        if(mApp->IsSurvivalEndless(mApp->mGameMode)){
            mBodyHealth = 35000 + (mBoard->mChallenge->mSurvivalStage / 5) * 5000;
            //mBodyHealth = 200;
        }
        if (IsOnBoard())
        {
    ...
    case ZombieType::ZOMBIE_PEA_HEAD:
    {
        ...
        UpdateHeadReanim("anim_head_idle", ReanimLoopType::REANIM_LOOP, 0, 15.0f);
    ...
    case ZombieType::ZOMBIE_WALLNUT_HEAD:
    {
        ...
        mSpecialHeadReanimID = mApp->ReanimationGetID(aHeadReanim);
        UpdateHeadReanim("anim_idle", ReanimLoopType::REANIM_LOOP, 0, 15.0f);
        AttachEffect* aAttachEffect = AttachReanim(aTrackInstance->mAttachmentID, aHeadReanim, 0.0f, 0.0f);
        aBodyReanim->mFrameBasePose = 0;
    ...
    case ZombieType::ZOMBIE_UMBRELLA_HEAD:
    {
        ...
        AttachEffect* aAttachEffect = AttachReanim(aTrackInstance->mAttachmentID, aHeadReanim, 0.0f, 0.0f);
        aBodyReanim->mFrameBasePose = 0;
        TodScaleRotateTransformMatrix(aAttachEffect->mOffset, 63.0f, -25.0f, 0.2f, -1.0f, 1.0f);

        mBodyHealth = 500;
        mVariant = false;
        break;
    }
    case ZombieType::ZOMBIE_CABBAGE_HEAD:
    {
        LoadPlainZombieReanim();
        ReanimShowPrefix("anim_hair", RENDER_GROUP_HIDDEN);
        ReanimShowPrefix("anim_head2", RENDER_GROUP_HIDDEN);
        ...
        aHeadReanim->AssignRenderGroupToPrefix("frontleaf_tip_left", RENDER_GROUP_HIDDEN);
        aHeadReanim->AssignRenderGroupToPrefix("frontleaf_right_tip", RENDER_GROUP_HIDDEN);
        aHeadReanim->AssignRenderGroupToPrefix("frontleaf", RENDER_GROUP_HIDDEN);
        aHeadReanim->AssignRenderGroupToPrefix("Cabbagepult_backleaf1", RENDER_GROUP_HIDDEN);
        aHeadReanim->AssignRenderGroupToPrefix("Cabbagepult_backleaf2", RENDER_GROUP_HIDDEN);
        mSpecialHeadReanimID = mApp->ReanimationGetID(aHeadReanim);
        UpdateHeadReanim("anim_idle", ReanimLoopType::REANIM_LOOP, 0, 15.0f);
        AttachEffect* aAttachEffect = AttachReanim(aTrackInstance->mAttachmentID, aHeadReanim, 0.0f, 0.0f);
        aBodyReanim->mFrameBasePose = 0;
    ...
    case ZombieType::ZOMBIE_MELON_HEAD:
    {
        LoadPlainZombieReanim();
        ReanimShowPrefix("anim_hair", RENDER_GROUP_HIDDEN);
        ReanimShowPrefix("anim_head2", RENDER_GROUP_HIDDEN);
        ...
        AttachEffect* aAttachEffect = AttachReanim(aTrackInstance->mAttachmentID, aHeadReanim, 0.0f, 0.0f);
        aBodyReanim->mFrameBasePose = 0;
        TodScaleRotateTransformMatrix(aAttachEffect->mOffset, 65.0f, -25.0f, 0.2f, -1.0f, 1.0f);
    ...
    case ZombieType::ZOMBIE_HYPNO_HEAD:
    {
        LoadPlainZombieReanim();
        ReanimShowPrefix("anim_hair", RENDER_GROUP_HIDDEN);
        ReanimShowPrefix("anim_head2", RENDER_GROUP_HIDDEN);
    ...
    case ZombieType::ZOMBIE_WINTERMELON_HEAD:
    {
        LoadPlainZombieReanim();
        ReanimShowPrefix("anim_hair", RENDER_GROUP_HIDDEN);
        ReanimShowPrefix("anim_head2", RENDER_GROUP_HIDDEN);
        ...
        ReanimatorTrackInstance* aTrackInstance = aBodyReanim->GetTrackInstanceByName("anim_head1");
        aTrackInstance->mImageOverride = IMAGE_BLANK;
        Reanimation* aHeadReanim = mApp->AddReanimation(0.0f, 0.0f, 0, ReanimationType::REANIM_WINTER_MELON);
        aHeadReanim->AssignRenderGroupToPrefix("frontleaf_tip_left", RENDER_GROUP_HIDDEN);
        aHeadReanim->AssignRenderGroupToPrefix("frontleaf_right_tip", RENDER_GROUP_HIDDEN);
        aHeadReanim->AssignRenderGroupToPrefix("frontleaf", RENDER_GROUP_HIDDEN);
        mSpecialHeadReanimID = mApp->ReanimationGetID(aHeadReanim);
...
void Zombie::SetupCachedLayers(Reanimation* aReanim, ZombieType theZombieType, Reanimation*& bReanim){
    ...
    switch(theZombieType){
        ...
        case ZombieType::ZOMBIE_UMBRELLA_HEAD:
        {
            ...
            bReanim = new Reanimation();
            bReanim->ReanimationInitializeType(0, 0, ReanimationType::REANIM_UMBRELLALEAF);
            bReanim->SetFramesForLayer("anim_idle");
            TodScaleRotateTransformMatrix(bReanim->mOverlayMatrix, 103.0f, 15.0f, 0.2f, -1.0f, 1.0f);
            break;
        }
        case ZombieType::ZOMBIE_CABBAGE_HEAD:
        {
            ...
            bReanim = new Reanimation();
            bReanim->ReanimationInitializeType(0, 0, ReanimationType::REANIM_CABBAGEPULT);//46.7, 48.8
            bReanim->SetFramesForLayer("anim_head_idle");
            bReanim->AssignRenderGroupToPrefix("frontleaf_tip_left", RENDER_GROUP_HIDDEN);
            ...
            bReanim->AssignRenderGroupToPrefix("Cabbagepult_backleaf1", RENDER_GROUP_HIDDEN);
            bReanim->AssignRenderGroupToPrefix("Cabbagepult_backleaf2", RENDER_GROUP_HIDDEN);
            TodScaleRotateTransformMatrix(bReanim->mOverlayMatrix, 105.0f, 20.0f, 0.2f, -1.0f, 1.0f); //65.0, -5.0
            break;
            break;
        }
        case ZombieType::ZOMBIE_MELON_HEAD:
        {
            ...
            bReanim = new Reanimation();
            bReanim->ReanimationInitializeType(0, 0, ReanimationType::REANIM_MELONPULT);//46.7, 48.8
            bReanim->SetFramesForLayer("anim_idle");
            bReanim->AssignRenderGroupToPrefix("frontleaf_tip_left", RENDER_GROUP_HIDDEN);
            bReanim->AssignRenderGroupToPrefix("frontleaf_right_tip", RENDER_GROUP_HIDDEN);
            bReanim->AssignRenderGroupToPrefix("frontleaf", RENDER_GROUP_HIDDEN);
        ...
        case ZombieType::ZOMBIE_SNOWPEA_HEAD:
        {
            ...
            bReanim = new Reanimation();
            bReanim->ReanimationInitializeType(0, 0, ReanimationType::REANIM_SNOWPEA);//46.7, 48.8
            bReanim->SetFramesForLayer("anim_head_idle");
            TodScaleRotateTransformMatrix(bReanim->mOverlayMatrix, 105.0f, 35.0f, 0.2f, -1.0f, 1.0f); //65.0, -5.0
            break;
        }
        case ZombieType::ZOMBIE_HYPNO_HEAD:
        {
            ...
            bReanim = new Reanimation();
            bReanim->ReanimationInitializeType(0, 0, ReanimationType::REANIM_HYPNOSHROOM);
            bReanim->SetFramesForLayer("anim_idle");
            TodScaleRotateTransformMatrix(bReanim->mOverlayMatrix, 95.0f, 25.0f, 0.2f, -0.75f, 0.75f);
            break;
        }
        case ZombieType::ZOMBIE_WINTERMELON_HEAD:
        {
            ...
            bReanim = new Reanimation();
            bReanim->ReanimationInitializeType(0, 0, ReanimationType::REANIM_WINTER_MELON);//46.7, 48.8
            bReanim->SetFramesForLayer("anim_idle");
            bReanim->AssignRenderGroupToPrefix("frontleaf_tip_left", RENDER_GROUP_HIDDEN);
            bReanim->AssignRenderGroupToPrefix("frontleaf_right_tip", RENDER_GROUP_HIDDEN);
            bReanim->AssignRenderGroupToPrefix("frontleaf", RENDER_GROUP_HIDDEN);
...
void Zombie::PickRandomSpeed()
{
    ...
    mZombieType == ZombieType::ZOMBIE_JACKSON || mZombieType == ZombieType::ZOMBIE_JACKSON_DANCER)
    {
        mVelX = 0.45f;
    }
    else if (mZombiePhase == ZombiePhase::PHASE_DIGGER_TUNNELING || mZombiePhase == ZombiePhase::PHASE_POLEVAULTER_PRE_VAULT || 
        mZombieType == ZombieType::ZOMBIE_FOOTBALL || mZombieType == ZombieType::ZOMBIE_GIGA_FOOTBALL || 
    ...
    mZombieType == ZombieType::ZOMBIE_HYPNO_HEAD)
    {
...
void Zombie::BungeeLanding()
{
    ...
    Plant* aPlant = mBoard->FindUmbrellaPlant(mTargetCol, mRow, false);
    if (aPlant)
    {
...
void Zombie::ZombieCatapultFire(Plant* thePlant)
{
    ...
    CreateLobProjectile(thePlant, ProjectileType::PROJECTILE_BASKETBALL, aOriginX, aOriginY);
...
PlantOrZombie Zombie::FindLobZombotanyTarget()
{
    PlantOrZombie aTarget;
    int aBest = 0;

    Plant* aPlant = nullptr;
    while (mBoard->IteratePlants(aPlant))
    {
        if(mMindControlled != aPlant->mMindControlled) continue;
        if (aPlant->mRow == mRow && ((!mMindControlled && mX >= aPlant->mX + 100) || (mMindControlled && mX <= aPlant->mX + 100)))
        {
            if (aTarget == nullptr || (!mMindControlled && aPlant->mX > aBest) || (mMindControlled && aPlant->mX < aBest))
            {
                aTarget = mBoard->GetTopPlantAt(aPlant->mPlantCol, aPlant->mRow, PlantPriority::TOPPLANT_CATAPULT_ORDER);
                aBest = aTarget.mPlant->mX;
            }
        }
    }

    Zombie* aZombie = nullptr;
    int aDamageRangeFlags = 13 + mMindControlled?0:128;
    while (mBoard->IterateZombies(aZombie))
    {
        if(mMindControlled == aZombie->mMindControlled) continue;
        if(!aZombie->EffectedByDamage(aDamageRangeFlags)) continue;
        if (aZombie->mRow == mRow && ((!mMindControlled && mX >= aZombie->mX + 100) || (mMindControlled && mX <= aZombie->mX + 100)))
        {
            if (aTarget == nullptr || (!mMindControlled && aZombie->mX > aBest) || (mMindControlled && aZombie->mX < aBest))
            {
                aTarget = aZombie;
                aBest = aZombie->mX;
            }
...
void Zombie::UpdateZombiePolevaulter()
{
    if (mZombiePhase == ZombiePhase::PHASE_POLEVAULTER_PRE_VAULT && mHasHead && mZombieHeight == ZombieHeight::HEIGHT_ZOMBIE_NORMAL)
    {
        ...
        if (aPlant)
        {
            if (mBoard->CanClimb(aPlant->mPlantCol, aPlant->mRow))
            {
...
void Zombie::UpdateZombiePeaHead()
{
    ...
    if (mPhaseCounter2 == 35)
    {
        UpdateHeadReanim("anim_shooting", ReanimLoopType::REANIM_PLAY_ONCE_AND_HOLD, 20, 35.0f);
    }
    else if (mPhaseCounter2 == 0)
    {
        UpdateHeadReanim("anim_head_idle", ReanimLoopType::REANIM_PLAY_ONCE_AND_HOLD, 20, 15.0f);
        ...
        else
        {
            ...
            aProjectile->mDamageRangeFlags = 129;
        }
...
void Zombie::UpdateZombieCabbageHead()
{
    if (!mHasHead)
        return;

    if (mPhaseCounter2 == 32)
    {
        UpdateHeadReanim("anim_shooting", ReanimLoopType::REANIM_PLAY_ONCE_AND_HOLD, 20, 35.0f);
    }
    else if (mPhaseCounter2 == 0)
    {
        ...
        float aOriginX = mPosX + aTransform.mTransX + 25.0f;
        float aOriginY = mPosY + aTransform.mTransY - 27.0f - mAltitude;
        PlantOrZombie aPlant = FindLobZombotanyTarget();
        if (mMindControlled)  // 魅惑修复
        {
            aOriginX += 90.0f * mScaleZombie;
            Projectile* aProjectile = CreateLobProjectile(aPlant, PROJECTILE_CABBAGE, aOriginX, aOriginY);
            aProjectile->mDamageRangeFlags = 13;
        }
        else
        {
            Projectile* aProjectile = CreateLobProjectile(aPlant, PROJECTILE_ZOMBIE_CABBAGE, aOriginX, aOriginY);
            aProjectile->mDamageRangeFlags = 141;
        }

        mPhaseCounter2 = 300;
    }
    else if (mPhaseCounter2 > 32){
        Reanimation* aHeadReanim = mApp->ReanimationGet(mSpecialHeadReanimID);
        if(aHeadReanim->mLoopCount > 0){
            UpdateHeadReanim("anim_idle", ReanimLoopType::REANIM_PLAY_ONCE_AND_HOLD, 20, 15.0f);
        }
    }
}

void Zombie::UpdateZombieMelonHead()
{
    if (!mHasHead)
        return;

    if (mPhaseCounter2 == 36)
    {
        UpdateHeadReanim("anim_shooting", ReanimLoopType::REANIM_PLAY_ONCE_AND_HOLD, 20, 35.0f);
    }
    else if (mPhaseCounter2 == 0)
    {
        ...
        float aOriginX = mPosX + aTransform.mTransX - 1.0f;
        float aOriginY = mPosY + aTransform.mTransY - 61.0f - mAltitude;
        PlantOrZombie aPlant = FindLobZombotanyTarget();
        if (mMindControlled)  // 魅惑修复
        {
            aOriginX += 90.0f * mScaleZombie;
            ProjectileType aTt = PROJECTILE_MELON;
            if(mZombieType == ZOMBIE_WINTERMELON_HEAD) aTt = PROJECTILE_WINTERMELON;
...
Projectile* Zombie::CreateLobProjectile(PlantOrZombie thePlant, ProjectileType aType, float aOriginX, float aOriginY){
    int aTargetX, aTargetY;
    if (thePlant.mPlant)
    {
        aTargetX = thePlant.mPlant->mX + 20;
        aTargetY = thePlant.mPlant->mY;
    }
    else if(thePlant.mZombie){
        int offsetX = 0;
        Rect aZombieRect = thePlant.mZombie->GetZombieRect();
        aTargetX = thePlant.mZombie->ZombieTargetLeadX(50.0f) - 30.0f;
        aTargetY = aZombieRect.mY;

        if (thePlant.mZombie->mZombiePhase == ZombiePhase::PHASE_DOLPHIN_RIDING)
        {
            offsetX += 60.0f;
        }
        if (thePlant.mZombie->mZombieType == ZombieType::ZOMBIE_POGO && thePlant.mZombie->mHasObject)
        {
            offsetX += 60.0f;
        }
        if (thePlant.mZombie->mZombiePhase == ZombiePhase::PHASE_SNORKEL_WALKING_IN_POOL)
        {
            offsetX += 40.0f;
        }
        if (thePlant.mZombie->mZombieType == ZombieType::ZOMBIE_BOSS)
        {
            aTargetY = mBoard->GridToPixelY(8, mRow);
        }
        if(mMindControlled) offsetX *= -1;
        aTargetX += offsetX;
    }
    else
    {
        aTargetX = mPosX + (mMindControlled?300.0f:-300.0f);
        aTargetY = 0.0f;
    }

    Projectile* aProjectile = mBoard->AddProjectile(aOriginX, aOriginY, mRenderOrder, mRow, aType);
    float aRangeX = aOriginX - aTargetX;
    float aRangeY = aTargetY - aOriginY;

    if(mMindControlled){
        if(aRangeX > -40.0f) aRangeX = -40.0f;
    }
    else if (aRangeX < 40.0f)
    {
        aRangeX = 40.0f;
    }
...
void Zombie::BurnRow(int theRow)  // 此函数专用于在定义了 DO_FIX_BUGS 时修复火爆辣椒僵尸的 Bug
{
    ...
    while (mBoard->IterateZombies(aZombie))
    {
        if ((aZombie->mZombieType == ZombieType::ZOMBIE_BOSS || aZombie->mRow == theRow) && aZombie->EffectedByDamage(mMindControlled?255:127))
        {
    ...
    while (mBoard->IteratePlants(aPlant))
    {
        if (aPlant->mRow == theRow && aPlant->mMindControlled == mMindControlled)
        {
            aPlant->Die();
            if(!mMindControlled) mBoard->mPlantsEaten++;
        }
    }
...
void Zombie::UpdateZombieGatlingHead()
{
    ...
    if (mPhaseCounter2 == 100)
    {
        UpdateHeadReanim("anim_shooting", ReanimLoopType::REANIM_PLAY_ONCE_AND_HOLD, 20, 38.0f);
    }
    else if (mPhaseCounter2 == 18 || mPhaseCounter2 == 35 || mPhaseCounter2 == 51 || mPhaseCounter2 == 68)
    {
        mApp->PlayFoley(FoleyType::FOLEY_THROW);
...
void Zombie::UpdateZombieSquashHead()
{
    if (mHasHead && mIsEating && mZombiePhase == ZombiePhase::PHASE_SQUASH_PRE_LAUNCH)
    {
        ...
        Reanimation* aHeadReanim = mApp->ReanimationGet(mSpecialHeadReanimID);
        UpdateHeadReanim("anim_jumpup", ReanimLoopType::REANIM_PLAY_ONCE_AND_HOLD, 20, 24.0f);
    ...
    if (mZombiePhase == ZombiePhase::PHASE_SQUASH_RISING)
    {
        ...
        int aPosX = TodAnimateCurve(50, 20, mPhaseCounter2, 0, aDestX - mPosX, TodCurves::CURVE_EASE_IN_OUT);
        int aPosY = TodAnimateCurve(50, 20, mPhaseCounter2, 0, -20, TodCurves::CURVE_EASE_IN_OUT);
        ...
        if (mPhaseCounter2 == 0)
        {
            UpdateHeadReanim("anim_jumpdown", ReanimLoopType::REANIM_PLAY_ONCE_AND_HOLD, 0, 60.0f);
    ...
    {
        int aPosY = TodAnimateCurve(10, 0, mPhaseCounter2, -20, 74, TodCurves::CURVE_LINEAR);
        int aDestX = mBoard->GridToPixelX(mBoard->PixelToGridXKeepOnBoard(mX, mY), mRow);
        if (mMindControlled)
        {
            Zombie* aZombie = FindZombieTarget();
    ...
    if (mZombiePhase == ZombiePhase::PHASE_SQUASH_DONE_FALLING && mPhaseCounter2 == 0)
    {
        Reanimation* aHeadReanim = mApp->ReanimationGet(mSpecialHeadReanimID);
...
void Zombie::UpdateZombieUmbrellaHead()
{
    ...
    Reanimation* aHeadReanim = mApp->ReanimationGet(mSpecialHeadReanimID);
    if (mZombotomyState == PlantState::STATE_UMBRELLA_TRIGGERED)
    {
        if (mZombotomyStateCountdown == 0)
        {
            aHeadReanim->mRenderOrder = Board::MakeRenderOrder(RenderLayer::RENDER_LAYER_PROJECTILE, mRow + 1, 0);
            for (int i = 0; i < aHeadReanim->mDefinition->mTracks.count; i++){
                 aHeadReanim->mTrackInstances[i].mIgnoreClipRect = true;
            }
            mZombotomyState = PlantState::STATE_UMBRELLA_REFLECTING;
        }
    }
    else if (mZombotomyState == PlantState::STATE_UMBRELLA_REFLECTING)
    {
        if (aHeadReanim->mLoopCount > 0)
        {
            UpdateHeadReanim("anim_idle", ReanimLoopType::REANIM_LOOP, 0, 15.0f);
            mZombotomyState = PlantState::STATE_NOTREADY;
            aHeadReanim->mRenderOrder = mRenderOrder;
            for (int i = 0; i < aHeadReanim->mDefinition->mTracks.count; i++){
                 aHeadReanim->mTrackInstances[i].mIgnoreClipRect = false;
            }
        }
    }
}
...
void Zombie::DoSpecial(){
    switch(mZombieType){
        case ZOMBIE_UMBRELLA_HEAD:{
            Reanimation* aHeadReanim = mApp->ReanimationGet(mSpecialHeadReanimID);
            if (mZombotomyState != PlantState::STATE_UMBRELLA_TRIGGERED && mZombotomyState != PlantState::STATE_UMBRELLA_REFLECTING)
            {
                mZombotomyState = PlantState::STATE_UMBRELLA_TRIGGERED;
                mZombotomyStateCountdown = 5;

                UpdateHeadReanim("anim_block", ReanimLoopType::REANIM_PLAY_ONCE_AND_HOLD, 0, 22.0f);
            }
...
{
    ZombieType aType = mZombieType == ZOMBIE_JACKSON?ZOMBIE_JACKSON_DANCER:ZOMBIE_BACKUP_DANCER;
    if (!mBoard->RowCanHaveZombieType(theRow, aType))
        return ZombieID::ZOMBIEID_NULL;

    Zombie* aZombie = mBoard->AddZombieInRow(aType, theRow, mFromWave);
    if (aZombie == nullptr)
        return ZombieID::ZOMBIEID_NULL;
    ...
    aZombie->mInPool = mBoard->IsPoolSquare(mBoard->PixelToGridX(aZombie->mX + 75, aZombie->mY), theRow) && 
        mBoard->IsPoolSquare(mBoard->PixelToGridX(aZombie->mX + 45, aZombie->mY), theRow) && 
        aZombie->mX < 680;

    aZombie->mAltitude = aZombie->mInPool?ZOMBIE_BACKUP_DANCER_RISE_HEIGHT_POOL:ZOMBIE_BACKUP_DANCER_RISE_HEIGHT;
    ...
    if(aZombie->mInPool){
        aZombie->ReanimIgnoreClipRect("Zombie_duckytube", false);
        aZombie->ReanimIgnoreClipRect("Zombie_whitewater", false);
        aZombie->ReanimIgnoreClipRect("Zombie_outerarm_hand", false);
        aZombie->ReanimIgnoreClipRect("Zombie_innerarm3", false);
    }

    aZombie->SetAnimRate(0.0f);
    aZombie->mMindControlled = mMindControlled;

    int aParticleX = static_cast<int>(aZombie->mPosX);
    int aParticleY = static_cast<int>(aZombie->mPosY);
    if(aZombie->mInPool){
        aParticleX += 23;
        aParticleY += 78;
    }
    ...
    if(aZombie->mInPool){
        mApp->AddReanimation(aParticleX, aParticleY, mRenderOrder + 1, ReanimationType::REANIM_SPLASH)->OverrideScale(0.8f, 0.8f);
        mApp->AddTodParticle(aParticleX + 37.0f, aParticleY + 42.0f, mRenderOrder + 1, ParticleEffect::PARTICLE_PLANTING_POOL);
        mApp->PlayFoley(FoleyType::FOLEY_PLANT_WATER);
    }
    else{
...
void Zombie::SummonBackupDancers()
{
    if (!mHasHead)
        return;
    int aCount = mZombieType == ZOMBIE_JACKSON?NUM_JACKSON_DANCERS:NUM_BACKUP_DANCERS;
    for (int i = 0; i < aCount; i++)
    {
        if (mBoard->ZombieTryToGet(mFollowerZombieID[i]) == nullptr)
        {
            ...
            case 4:     aRow = mRow - 1;        aPosX = mPosX - 100;    break;
            case 5:     aRow = mRow + 1;        aPosX = mPosX - 100;    break;
            case 6:     aRow = mRow - 1;        aPosX = mPosX + 100;    break;
            case 7:     aRow = mRow + 1;        aPosX = mPosX + 100;    break;
            case 8:     aRow = mRow - 2;        aPosX = mPosX;    break;
            case 9:     aRow = mRow + 2;        aPosX = mPosX;    break;
            case 10:     aRow = mRow;        aPosX = mPosX - 200;    break;
            case 11:     aRow = mRow;        aPosX = mPosX + 200;    break;
...
bool Zombie::NeedsMoreBackupDancers()
{
    ...
    for (int i = 0; i < aCount; i++)
    {
        if (mBoard->ZombieTryToGet(mFollowerZombieID[i]) == nullptr)
        {
            if ((i == 0 || i == 4 || i == 6) && !mBoard->RowCanHaveZombieType(mRow - 1, aType))
            {
                continue;
            }

            if ((i == 1 || i == 5 || i == 7) && !mBoard->RowCanHaveZombieType(mRow + 1, aType))
            {
                continue;
            }
            
            if (i == 8 && !mBoard->RowCanHaveZombieType(mRow - 2, aType))
            {
                continue;
            }
            
            if (i == 9 && !mBoard->RowCanHaveZombieType(mRow + 2, aType))
            {
                continue;
            }
...
void Zombie::UpdateZombieBackupDancer()
{
    ...
    {
        if(mInPool)
            mAltitude = TodAnimateCurve(150, 0, mPhaseCounter, ZOMBIE_BACKUP_DANCER_RISE_HEIGHT_POOL, -40, TodCurves::CURVE_LINEAR);
        else
    ...
    if (aDancerPhase != mZombiePhase)
    {
        ...
        case ZombiePhase::PHASE_DANCER_DANCING_LEFT:
            ...
            if(mInPool) PlayZombieReanim("anim_swim", ReanimLoopType::REANIM_LOOP, 10, 0.0f);
            else PlayZombieReanim("anim_walk", ReanimLoopType::REANIM_LOOP, 10, 0.0f);
            break;

        case ZombiePhase::PHASE_DANCER_WALK_TO_RAISE:
            mZombiePhase = aDancerPhase;
            if(mInPool) PlayZombieReanim("anim_waterarmraise", ReanimLoopType::REANIM_LOOP, 10, 18.0f);
            else PlayZombieReanim("anim_armraise", ReanimLoopType::REANIM_LOOP, 10, 18.0f);
...
void Zombie::OverrideParticleColor(TodParticleSystem* aParticle)
{
    if (aParticle)
    {
        if(mMindControlled && (mChilledCounter > 0 || mIceTrapCounter > 0)){
            aParticle->OverrideColor(nullptr, Color(38, 0, 192, 255));
...
void Zombie::SetupReanimForLostArm(unsigned int theDamageFlags)
{
    ...
    case ZombieType::ZOMBIE_GIGA_FOOTBALL:
        ReanimShowPrefix("Zombie_football_leftarm_lower", RENDER_GROUP_HIDDEN);
        ReanimShowPrefix("Zombie_football_leftarm_hand_giga", RENDER_GROUP_HIDDEN);
        break;
    case ZombieType::ZOMBIE_NEWSPAPER:
    ...
    if (aBodyReanim)
    {
        ...
        case ZombieType::ZOMBIE_FOOTBALL:
            ...
            break;
        case ZombieType::ZOMBIE_GIGA_FOOTBALL:
            GetTrackPosition("Zombie_football_leftarm_hand_giga", aPosX, aPosY);
            aBodyReanim->SetImageOverride("Zombie_football_leftarm_upper", IMAGE_REANIM_ZOMBIE_FOOTBALL_LEFTARM_UPPER2);
            break;
        case ZombieType::ZOMBIE_NEWSPAPER:
        ...
        case ZombieType::ZOMBIE_JACKSON:
            // @Patoke: updated for new assets
            GetTrackPosition("Zombie_outerarm_lower", aPosX, aPosY);
            aBodyReanim->SetImageOverride("Zombie_outerarm_upper", IMAGE_REANIM_ZOMBIE_JACKSON_OUTERARM_UPPER2);
            break;
        case ZombieType::ZOMBIE_JACKSON_DANCER:
            // @Patoke: updated for new assets
            GetTrackPosition("Zombie_outerarm_lower", aPosX, aPosY);
            aBodyReanim->SetImageOverride("Zombie_outerarm_upper", IMAGE_REANIM_ZOMBIE_DANCER_OUTERARM_UPPER2);
            break;
        case ZombieType::ZOMBIE_LADDER:
    ...
    if (!mInPool && !TestBit(theDamageFlags, DamageFlags::DAMAGE_DOESNT_LEAVE_BODY))
    {
        ...
        if (aParticle)
        {
            ...
            case ZombieType::ZOMBIE_FOOTBALL:
                ...
                break;
            case ZombieType::ZOMBIE_GIGA_FOOTBALL:
                aParticle->OverrideImage(nullptr, IMAGE_REANIM_ZOMBIE_FOOTBALL_LEFTARM_HAND_GIGA);
                break;
            case ZombieType::ZOMBIE_NEWSPAPER:
            ...
            case ZombieType::ZOMBIE_BACKUP_DANCER:
                ...
                break;
            case ZombieType::ZOMBIE_JACKSON:
                aParticle->OverrideImage(nullptr, IMAGE_REANIM_ZOMBIE_JACKSON_INNERARM_HAND);
                break;
            case ZombieType::ZOMBIE_JACKSON_DANCER:
                aParticle->OverrideImage(nullptr, IMAGE_REANIM_ZOMBIE_JACKSON_INNERARM_HAND);
                break;
...
bool Zombie::ZombieNotWalking()
{
    ...
    )
    {
        ...
        if (aLeader)
        {
            ...
            int aCount = (mZombieType == ZombieType::ZOMBIE_JACKSON || mZombieType == ZombieType::ZOMBIE_JACKSON_DANCER)?NUM_JACKSON_DANCERS:NUM_BACKUP_DANCERS;
            for (int i = 0; i < aCount; i++)
            {
...
void Zombie::Update()
{
    ...
    if (doUpdate)
    {
        ...
        else
        {
            ...
            if (mZombotomyStateCountdown > 0 && !IsImmobilizied())
            {
                if(mChilledCounter <= 0 || mZombieAge % 2 == 0)
                    mZombotomyStateCountdown--;
            }
            if (mPhaseCounter2 > 0 && !IsImmobilizied())
            {
                if(mChilledCounter <= 0 || mZombieAge % 2 == 0)
                    mPhaseCounter2--;
            }
...
void Zombie::UpdateClimbingLadder()
{
    ...
    if (!mBoard->CanClimb(aLadderOriginX, mRow))
    {
        mZombieHeight = ZombieHeight::HEIGHT_FALLING;
        return;
    }
...
void Zombie::UpdateActions()
{
    ...
    if (mZombieType == ZombieType::ZOMBIE_BACKUP_DANCER || mZombieType == ZombieType::ZOMBIE_JACKSON_DANCER)
    {
    ...
    {
        if(mChilledCounter <= 0 || mZombieAge % 2 == 0) UpdateZombiePeaHead();
    }
    if (mZombieType == ZombieType::ZOMBIE_JALAPENO_HEAD)
    {
        if(mChilledCounter <= 0 || mZombieAge % 2 == 0) UpdateZombieJalapenoHead();
    }
    if (mZombieType == ZombieType::ZOMBIE_GATLING_HEAD)
    {
        if(mChilledCounter <= 0 || mZombieAge % 2 == 0) UpdateZombieGatlingHead();
    }
    if (mZombieType == ZombieType::ZOMBIE_SQUASH_HEAD)
    {
        if(mChilledCounter <= 0 || mZombieAge % 2 == 0) UpdateZombieSquashHead();
    }
    if (mZombieType == ZombieType::ZOMBIE_UMBRELLA_HEAD)
    {
        if(mChilledCounter <= 0 || mZombieAge % 2 == 0) UpdateZombieUmbrellaHead();
    }
    if (mZombieType == ZombieType::ZOMBIE_CABBAGE_HEAD)
    {
        if(mChilledCounter <= 0 || mZombieAge % 2 == 0) UpdateZombieCabbageHead();
    }
    if (mZombieType == ZombieType::ZOMBIE_MELON_HEAD || mZombieType == ZombieType::ZOMBIE_WINTERMELON_HEAD)
    {
        if(mChilledCounter <= 0 || mZombieAge % 2 == 0) UpdateZombieMelonHead();
    }
    if (mZombieType == ZombieType::ZOMBIE_SNOWPEA_HEAD)
    {
        if(mChilledCounter <= 0 || mZombieAge % 2 == 0) UpdateZombieSnowPeaHead();
    }
}
...
void Zombie::CheckForBoardEdge()
{
    ...
    else if (mZombieType == ZombieType::ZOMBIE_CATAPULT || mZombieType == ZombieType::ZOMBIE_FOOTBALL || mZombieType == ZombieType::ZOMBIE_GIGA_FOOTBALL || mZombieType == ZombieType::ZOMBIE_ZAMBONI)
    {
        ...
        mZombieType == ZombieType::ZOMBIE_JACKSON_DANCER || mZombieType == ZombieType::ZOMBIE_JACKSON
    )
    {
        aEdgeX = -130;
    }
...
bool Zombie::HasYuckyFaceImage()
{
    ...
    return 
        ...
        mZombieType == ZombieType::ZOMBIE_DOOR_PAIL || 
...
bool Zombie::CanTargetPlant(Plant* thePlant, ZombieAttackType theAttackType)
{
    ...
    if (mZombiePhase == ZombiePhase::PHASE_LADDER_CARRYING || mZombiePhase == ZombiePhase::PHASE_LADDER_PLACING)
    {
        ...
        if (mBoard->CanClimb(thePlant->mPlantCol, thePlant->mRow))
        {
            aPlaceLadder = false;
        }
...
Plant* Zombie::FindPlantTarget(ZombieAttackType theAttackType)
{
    ...
    while (mBoard->IteratePlants(aPlant))
    {
        if(aPlant->mMindControlled != mMindControlled) continue;
        if (aPlant->mRow == mRow)
        {
...
bool Zombie::IsMovingAtChilledSpeed()
{
    ...
    if (mZombieType == ZombieType::ZOMBIE_JACKSON || mZombieType == ZombieType::ZOMBIE_JACKSON_DANCER)
    {
        Zombie* aLeader;
        ...
        if (aLeader)
        {
            ...
            for (int i = 0; i < NUM_JACKSON_DANCERS; i++)
            {
                Zombie* aDancer = mBoard->ZombieTryToGet(aLeader->mFollowerZombieID[i]);
                if (aDancer && aDancer->mChilledCounter > 0)
                {
...
void Zombie::ApplyAnimRate(float theAnimRate)
{
    ...
    if (aHeadReanim)
    {
        aHeadReanim->mAnimRate = theAnimRate == 0 ? 0 : (IsMovingAtChilledSpeed() ? mHeadAnimRate * 0.5f : mHeadAnimRate);
    }
}

void Zombie::UpdateHeadReanim(const char* theTrackName, ReanimLoopType theLoopType, int theBlendTime, float theAnimeRate){
    Reanimation* aHeadReanim = mApp->ReanimationTryToGet(mSpecialHeadReanimID);
    if(!aHeadReanim) return;
    mHeadAnimRate = theAnimeRate;
    float aRate = mHeadAnimRate;
    if(mZombieType != ZOMBIE_BOSS) aRate = IsMovingAtChilledSpeed() ? mHeadAnimRate * 0.5f : mHeadAnimRate;
    aHeadReanim->PlayReanim(theTrackName, theLoopType, theBlendTime, aRate);
}
...
void Zombie::StartMindControlled()
{
    ...
    else if(mZombieType == ZombieType::ZOMBIE_JACKSON_DANCER){
        Zombie* aLeader = mBoard->ZombieTryToGet(mRelatedZombieID);
        if (aLeader)
        {
            ZombieID aId = mBoard->ZombieGetID(this);
...
void Zombie::EatPlant(Plant* thePlant)
{
    ...
    if (mZombieType == ZOMBIE_HYPNO_HEAD)
    {
        PlayZombieReanim("anim_idle", ReanimLoopType::REANIM_LOOP, 20, 12.0f);
        mHasHead = false;
        Reanimation* aHeadReanim = mApp->ReanimationGet(mSpecialHeadReanimID);
        ...
        mBoard->GetPlantsOnLawn(thePlant->mPlantCol, thePlant->mRow, &aPlantOnLawn);
        if(aPlantOnLawn.mFlyingPlant) aPlantOnLawn.mFlyingPlant->StartMindControlled();
        if(aPlantOnLawn.mNormalPlant) aPlantOnLawn.mNormalPlant->StartMindControlled();
        if(aPlantOnLawn.mPumpkinPlant) aPlantOnLawn.mPumpkinPlant->StartMindControlled();
        if(aPlantOnLawn.mUnderPlant) aPlantOnLawn.mUnderPlant->StartMindControlled();
        if(aPlantOnLawn.mUnderPlant2) aPlantOnLawn.mUnderPlant2->StartMindControlled();
    ...
    if (mBoard->CanClimb(thePlant->mPlantCol, thePlant->mRow) && mZombieType != ZombieType::ZOMBIE_DIGGER)  // 矿工僵尸无视梯子
    {
        StopEating();
    ...
    if (thePlant->mSeedType == SeedType::SEED_JALAPENO || 
        ...
        thePlant->mState == PlantState::STATE_WATERPOT_INVULNERABLE || 
    ...
    if (mApp->IsIZombieLevel() && thePlant->mSeedType == SeedType::SEED_SUNFLOWER)
    {
        ...
        int aStageAfterChew = (thePlant->mPlantHealth - DamagePerEat()) / 40;
        if (aStageAfterChew < aStageBeforeChew || thePlant->mPlantHealth - DamagePerEat() <= 0)  // 若本次啃食令植物血量下降了至少 1 个阶段
        {
            mBoard->AddCoin(thePlant->mX, thePlant->mY, CoinType::COIN_SUN, CoinMotion::COIN_MOTION_FROM_PLANT);
        }
    }

    thePlant->mPlantHealth -= DamagePerEat();
...
void Zombie::EatZombie(Zombie* theZombie)
{
    ...
    theZombie->TakeDamage(DamagePerEat(), 9U);
    StartEating();
...
int Zombie::DamagePerEat(){
    if (mZombieType == ZombieType::ZOMBIE_DANCER || mZombieType == ZombieType::ZOMBIE_BACKUP_DANCER || 
        mZombieType == ZombieType::ZOMBIE_FLAG ||
    mZombieType == ZombieType::ZOMBIE_JACKSON || mZombieType == ZombieType::ZOMBIE_JACKSON_DANCER)
    {
        return DAMAGE_PER_EAT * 1.5;
    }
    else if (mZombieType == ZombieType::ZOMBIE_FOOTBALL || mZombieType == ZombieType::ZOMBIE_GIGA_FOOTBALL || 
        mZombieType == ZombieType::ZOMBIE_SNORKEL || mZombieType == ZombieType::ZOMBIE_JACK_IN_THE_BOX)
    {
        return DAMAGE_PER_EAT * 2;
    }
    else if (mZombiePhase == ZombiePhase::PHASE_LADDER_CARRYING || mZombiePhase == ZombiePhase::PHASE_YETI_RUNNING)
    {
        return DAMAGE_PER_EAT * 2.5;
    }
    else if (mZombiePhase == ZombiePhase::PHASE_NEWSPAPER_MAD)
    {
        return DAMAGE_PER_EAT * 3;
    }

    return DAMAGE_PER_EAT;
}
    ...
    if (mZombieType == ZombieType::ZOMBIE_BOSS)
    {
        ...
        if(mApp->IsSurvivalEndless(mApp->mGameMode)){
            ...
            for(int ss = 0; ss < 5; ss++){
                mBoard->AddCoin(570 + RandRangeInt(-50, 50), 130 + RandRangeInt(-40, 40), CoinType::COIN_ULTIMATESUN, CoinMotion::COIN_MOTION_FROM_PLANT);
            }
        }
    }
...
void Zombie::DropLoot()
{
    ...
    mApp->mPlayerInfo->mZombieDefeated[mZombieType] = true;
    if (mZombieType == ZombieType::ZOMBIE_YETI)
    {
        ...
        if (mBoard)
        {
            ...
            while (mBoard->IterateZombies(aZombie))
            {
                if (aZombie->mHasHead && !aZombie->IsDeadOrDying() && aZombie->IsOnBoard() && 
                    ...
                    aZombie->mZombieType == ZombieType::ZOMBIE_JACKSON || aZombie->mZombieType == ZombieType::ZOMBIE_JACKSON_DANCER 
                    ))
                {
                    aStopSound = true;
                    break;
...
void Zombie::DropHelm(unsigned int theDamageFlags)
{
    ...
    else if (mHelmType == HelmType::HELMTYPE_FOOTBALL || mHelmType == HelmType::HELMTYPE_GIGA_FOOTBALL)
    {
        ...
        if(mHelmType == HelmType::HELMTYPE_GIGA_FOOTBALL) aEffect = ParticleEffect::PARTICLE_ZOMBIE_HELMET_GIGA;
    }
...
int Zombie::TakeHelmDamage(int theDamage, unsigned int theDamageFlags)
{
    ...
    if (aDamageIndexBeforeDamage != aDamageIndexAfterDamage)
    {
        ...
        {
            TOD_ASSERT(aBodyReanim);
            aBodyReanim->SetImageOverride("zombie_football_helmet", IMAGE_REANIM_ZOMBIE_FOOTBALL_HELMET2_GIGA);
        }
        else if (mHelmType == HelmType::HELMTYPE_GIGA_FOOTBALL && aDamageIndexAfterDamage == 2)
        {
            TOD_ASSERT(aBodyReanim);
            aBodyReanim->SetImageOverride("zombie_football_helmet", IMAGE_REANIM_ZOMBIE_FOOTBALL_HELMET3_GIGA);
        }
...
void Zombie::RiseFromGrave(int theCol, int theRow)
{
    ...
    if (mBoard->StageHasPool() && mBoard->IsPoolSquare(theCol, theRow))
    {
        mAltitude = -150.0f;
        mInPool = true;
        mPhaseCounter = 50;
...
bool Zombie::IsZombotany(ZombieType theZombieType)
{
    return
        ...
        theZombieType == ZombieType::ZOMBIE_MELON_HEAD ||
        theZombieType == ZombieType::ZOMBIE_SNOWPEA_HEAD ||
        theZombieType == ZombieType::ZOMBIE_HYPNO_HEAD ||
        theZombieType == ZombieType::ZOMBIE_WINTERMELON_HEAD;
}
...
void Zombie::RemoveButter()
{
    ...
    /*if (Zombie::IsZombotany(mZombieType))
    {
        ...
        if (aHeadReanim)
        {
            ...
            {
                aHeadReanim->mAnimRate = mHeadAnimRate = 35.0f;
            }
            else if (mZombieType == ZombieType::ZOMBIE_GATLING_HEAD && aHeadReanim->IsAnimPlaying("anim_shooting"))
            {
                aHeadReanim->mAnimRate = mHeadAnimRate = 38.0f;
            }
            else
            {
                aHeadReanim->mAnimRate = mHeadAnimRate = 15.0f;
            }
        }
    }*/
...
bool Zombie::BurnDidntKill(){
    if(mZombieType == ZombieType::ZOMBIE_BOSS) return true;
    if(mZombieType == ZombieType::ZOMBIE_GIGA_FOOTBALL){
        return mBodyHealth + mHelmHealth > 1800;
    }
    return mBodyHealth > 1800;
}
...
void Zombie::ApplyBurn()
{
    ...
    if ((mZombieType == ZombieType::ZOMBIE_SQUASH_HEAD || mZombieType == ZOMBIE_HYPNO_HEAD) && !mHasHead)
    {
        mApp->RemoveReanimation(mSpecialHeadReanimID);
        mSpecialHeadReanimID = ReanimationID::REANIMATIONID_NULL;
    }
...
void Zombie::PlayDeathAnim(unsigned int theDamageFlags)
{
    ...
    else if (mZombieType == ZombieType::ZOMBIE_BOSS)
    {
        ...
        BossDie();
        Reanimation* aHeadReanim = mApp->ReanimationGet(mSpecialHeadReanimID);
        UpdateHeadReanim("anim_death", ReanimLoopType::REANIM_PLAY_ONCE_AND_HOLD, 20, aDeathAnimRate);
    }
    else
    {
...
void Zombie::UpdateDeath()
{
    ...
    if (mZombieType == ZombieType::ZOMBIE_BOSS)
    {
        ...
        {
            UpdateHeadReanim("anim_flag", ReanimLoopType::REANIM_PLAY_ONCE_AND_HOLD, 20, 30.0f);
        }

        if (aHeadReanim->IsAnimPlaying("anim_flag") && aHeadReanim->mLoopCount > 0)
        {
            UpdateHeadReanim("anim_flag_loop", ReanimLoopType::REANIM_LOOP, 20, 17.0f);
        }

        if(mZombieFade == -1 && mApp->IsMiddleBossLevel() && aHeadReanim->IsAnimPlaying("anim_flag_loop"))
            mZombieFade = 500;
...
void Zombie::BossRVAttack()
{
    ...
    mTargetRow = RandRangeInt(0, mBoard->StageHas6Rows() ? 4 : 3);
...
void Zombie::BossSpawnAttack()
{
    ...
    float diffi = 1.0f;
    if(mApp->IsSurvivalEndless(mApp->mGameMode)){
        diffi += (mBoard->mChallenge->mSurvivalStage / 5) * 0.1;
    }
    if (mBossMode == 0)
    {
    ...
    mSummonCounter /= diffi;

    if (mZombieAge < 3500 / diffi)
    {
        mTargetType = ZombieType::ZOMBIE_NORMAL;
    }
    else if (mZombieAge < 8000 / diffi)
    {
        mTargetType = ZombieType::ZOMBIE_TRAFFIC_CONE;
    }
    else if (mZombieAge < 12500 / diffi)
    {
    ...
    case 5:     aTrackName = "anim_spawn_6";    break;
    default:    TOD_ASSERT(false);                   break;
    }
...
{
    if(mBoard->mCurrentWave < 5)
        mBoard->mCurrentWave += 1;
    Zombie* aZombie = mBoard->AddZombieInRow(mTargetType, mTargetRow, mBoard->mCurrentWave);
...
void Zombie::BossStompAttack()
{
    ...
    case 4:     aTrackName = "anim_stomp_5";    break;
    default:    TOD_ASSERT(false);                   break;
    }
    PlayZombieReanim(aTrackName, ReanimLoopType::REANIM_PLAY_ONCE_AND_HOLD, 20, 12.0f);
    mApp->PlayFoley(FoleyType::FOLEY_HYDRAULIC_SHORT);
...
void Zombie::BossHeadSpit()
{
    ...
    mZombiePhase = ZombiePhase::PHASE_BOSS_HEAD_SPIT;
    mFireballRow = RandRangeInt(0, mBoard->StageHas6Rows() ? 5 : 4);
    ...
    case 5:     aTrackName = "anim_head_attack_6";      break;
    default:    TOD_ASSERT(false);                           break;
    }
    PlayZombieReanim(aTrackName, ReanimLoopType::REANIM_PLAY_ONCE_AND_HOLD, 20, 12.0f);
    ...
    UpdateHeadReanim("anim_drive", ReanimLoopType::REANIM_LOOP, 20, 36.0f);
}
...
Rect Zombie::GetBossFireballRect()
{
    Reanimation* aFireballReanim = mApp->ReanimationTryToGet(mBossFireBallReanimID);
    if (aFireballReanim == nullptr)
        return Rect();
    float aPosX = aFireballReanim->mOverlayMatrix.m02;
    float aPosY = aFireballReanim->mOverlayMatrix.m12;

    Rect aBallRect = Rect(aPosX, aPosY, 150, 150);
...
void Zombie::UpdateBoss()
{
    ...
    else if (mZombiePhase == ZombiePhase::PHASE_BOSS_HEAD_SPIT)
    {
        ...
        if (aBodyReanim->mLoopCount > 0)
        {
            UpdateHeadReanim("anim_idle", ReanimLoopType::REANIM_LOOP, 20, 18.0f);
            mZombiePhase = ZombiePhase::PHASE_BOSS_HEAD_IDLE_AFTER_SPIT;
            PlayZombieReanim("anim_head_idle", ReanimLoopType::REANIM_LOOP, 0, 12.0f);
            mPhaseCounter = 300;
        }
...
void Zombie::BossSetupReanim()
{
    ...
    mSpecialHeadReanimID = mApp->ReanimationGetID(aHeadReanim);
    UpdateHeadReanim("anim_idle", ReanimLoopType::REANIM_LOOP, 0, 18.0f);
...
void Zombie::PreloadZombieResources(ZombieType theZombieType)
{
    ...
    {
        ReanimatorEnsureDefinitionLoaded(ReanimationType::REANIM_ZOMBIE_DANCER, true);
    }

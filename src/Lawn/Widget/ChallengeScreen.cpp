...
constinit const ChallengeDefinition gChallengeDefs[NUM_CHALLENGE_MODES] = {
	...
	{ .mChallengeMode = GameMode::GAMEMODE_SURVIVAL_ENDLESS_STAGE_1,            .mChallengeIconIndex = 10,  .mPage = ChallengePage::CHALLENGE_PAGE_SURVIVAL,    .mRow = 2,  .mCol = 0,  .mChallengeName = "[SURVIVAL_DAY_ENDLESS]" },
	{ .mChallengeMode = GameMode::GAMEMODE_SURVIVAL_ENDLESS_STAGE_2,            .mChallengeIconIndex = 10,  .mPage = ChallengePage::CHALLENGE_PAGE_SURVIVAL,    .mRow = 2,  .mCol = 1,  .mChallengeName = "[SURVIVAL_NIGHT_ENDLESS]" },
	...
	{ .mChallengeMode = GameMode::GAMEMODE_SURVIVAL_ENDLESS_STAGE_4,            .mChallengeIconIndex = 10,  .mPage = ChallengePage::CHALLENGE_PAGE_SURVIVAL,    .mRow = 2,  .mCol = 3,  .mChallengeName = "[SURVIVAL_FOG_ENDLESS]" },
	{ .mChallengeMode = GameMode::GAMEMODE_SURVIVAL_ENDLESS_STAGE_5,            .mChallengeIconIndex = 10,  .mPage = ChallengePage::CHALLENGE_PAGE_SURVIVAL,    .mRow = 2,  .mCol = 4,  .mChallengeName = "[SURVIVAL_ROOF_ENDLESS]" },
	...
	{ .mChallengeMode = GameMode::GAMEMODE_CHALLENGE_ICE,                       .mChallengeIconIndex = 6,   .mPage = ChallengePage::CHALLENGE_PAGE_NONE,        .mRow = 1,  .mCol = 1,  .mChallengeName = "[ICE_LEVEL]" },
	{ .mChallengeMode = GameMode::GAMEMODE_CHALLENGE_ZEN_GARDEN,                .mChallengeIconIndex = 7,   .mPage = ChallengePage::CHALLENGE_PAGE_NONE,        .mRow = 1,  .mCol = 2,  .mChallengeName = "[ZEN_GARDEN]" },
	{ .mChallengeMode = GameMode::GAMEMODE_CHALLENGE_HIGH_GRAVITY,              .mChallengeIconIndex = 8,   .mPage = ChallengePage::CHALLENGE_PAGE_LIMBO,       .mRow = 1,  .mCol = 1,  .mChallengeName = "[HIGH_GRAVITY]" },
	{ .mChallengeMode = GameMode::GAMEMODE_CHALLENGE_GRAVE_DANGER,              .mChallengeIconIndex = 11,  .mPage = ChallengePage::CHALLENGE_PAGE_LIMBO,       .mRow = 1,  .mCol = 2,  .mChallengeName = "[GRAVE_DANGER]" },
	{ .mChallengeMode = GameMode::GAMEMODE_CHALLENGE_SHOVEL,                    .mChallengeIconIndex = 10,  .mPage = ChallengePage::CHALLENGE_PAGE_LIMBO,       .mRow = 1,  .mCol = 3,  .mChallengeName = "[CAN_YOU_DIG_IT]" },
	{ .mChallengeMode = GameMode::GAMEMODE_CHALLENGE_STORMY_NIGHT,              .mChallengeIconIndex = 13,  .mPage = ChallengePage::CHALLENGE_PAGE_LIMBO,       .mRow = 1,  .mCol = 4,  .mChallengeName = "[DARK_STORMY_NIGHT]" },
	{ .mChallengeMode = GameMode::GAMEMODE_CHALLENGE_BUNGEE_BLITZ,              .mChallengeIconIndex = 9,   .mPage = ChallengePage::CHALLENGE_PAGE_LIMBO,       .mRow = 2,  .mCol = 0,  .mChallengeName = "[BUNGEE_BLITZ]" },
	{ .mChallengeMode = GameMode::GAMEMODE_CHALLENGE_SQUIRREL,                  .mChallengeIconIndex = 10,  .mPage = ChallengePage::CHALLENGE_PAGE_NONE,        .mRow = 2,  .mCol = 1,  .mChallengeName = "Squirrel" },
	{ .mChallengeMode = GameMode::GAMEMODE_TREE_OF_WISDOM,                      .mChallengeIconIndex = 10,  .mPage = ChallengePage::CHALLENGE_PAGE_NONE,        .mRow = 2,  .mCol = 4,  .mChallengeName = "Tree of Wisdom" }, // @Patoke: replaced for english
	...
	{ .mChallengeMode = GameMode::GAMEMODE_UPSELL,                              .mChallengeIconIndex = 10,  .mPage = ChallengePage::CHALLENGE_PAGE_NONE,        .mRow = 3,  .mCol = 2,  .mChallengeName = "Upsell" },
	{ .mChallengeMode = GameMode::GAMEMODE_INTRO,                               .mChallengeIconIndex = 10,  .mPage = ChallengePage::CHALLENGE_PAGE_NONE,        .mRow = 2,  .mCol = 3,  .mChallengeName = "Intro" },
	{ .mChallengeMode = GameMode::GAMEMODE_CHALLENGE_WALLNUT_BOWLING_3,         .mChallengeIconIndex = 6,   .mPage = ChallengePage::CHALLENGE_PAGE_LIMBO,   	.mRow = 2,  .mCol = 1,  .mChallengeName = "[WALL_NUT_BOWLING_EXTREME]" },
	{ .mChallengeMode = GameMode::GAMEMODE_CHALLENGE_WHACK_A_ZOMBIE_2,          .mChallengeIconIndex = 16,  .mPage = ChallengePage::CHALLENGE_PAGE_LIMBO,   	.mRow = 2,  .mCol = 2,  .mChallengeName = "[WHACK_A_ZOMBIE_EXTREME]" },
	{ .mChallengeMode = GameMode::GAMEMODE_SURVIVAL_CUSTOM_STAGE_1,             .mChallengeIconIndex = 10,  .mPage = ChallengePage::CHALLENGE_PAGE_SURVIVAL_2,  .mRow = 0,  .mCol = 0,  .mChallengeName = "[SURVIVAL_CUSTOM]" },
	{ .mChallengeMode = GameMode::GAMEMODE_SURVIVAL_CUSTOM_STAGE_2,             .mChallengeIconIndex = 10,  .mPage = ChallengePage::CHALLENGE_PAGE_SURVIVAL_2,  .mRow = 0,  .mCol = 1,  .mChallengeName = "[SURVIVAL_CUSTOM]" },
	{ .mChallengeMode = GameMode::GAMEMODE_SURVIVAL_CUSTOM_STAGE_3,             .mChallengeIconIndex = 10,  .mPage = ChallengePage::CHALLENGE_PAGE_SURVIVAL_2,  .mRow = 0,  .mCol = 2,  .mChallengeName = "[SURVIVAL_CUSTOM]" },
	{ .mChallengeMode = GameMode::GAMEMODE_SURVIVAL_CUSTOM_STAGE_4,             .mChallengeIconIndex = 10,  .mPage = ChallengePage::CHALLENGE_PAGE_SURVIVAL_2,  .mRow = 0,  .mCol = 3,  .mChallengeName = "[SURVIVAL_CUSTOM]" },
	{ .mChallengeMode = GameMode::GAMEMODE_SURVIVAL_CUSTOM_STAGE_5,             .mChallengeIconIndex = 10,  .mPage = ChallengePage::CHALLENGE_PAGE_SURVIVAL_2,  .mRow = 0,  .mCol = 4,  .mChallengeName = "[SURVIVAL_CUSTOM]" },
	{ .mChallengeMode = GameMode::GAMEMODE_SURVIVAL_CUSTOM_STAGE_6,             .mChallengeIconIndex = 10,  .mPage = ChallengePage::CHALLENGE_PAGE_SURVIVAL_2,  .mRow = 1,  .mCol = 0,  .mChallengeName = "[SURVIVAL_CUSTOM]" },
	{ .mChallengeMode = GameMode::GAMEMODE_SURVIVAL_CUSTOM_STAGE_7,             .mChallengeIconIndex = 10,  .mPage = ChallengePage::CHALLENGE_PAGE_SURVIVAL_2,  .mRow = 1,  .mCol = 1,  .mChallengeName = "[SURVIVAL_CUSTOM]" },
	{ .mChallengeMode = GameMode::GAMEMODE_SURVIVAL_CUSTOM_STAGE_8,             .mChallengeIconIndex = 10,  .mPage = ChallengePage::CHALLENGE_PAGE_SURVIVAL_2,  .mRow = 1,  .mCol = 2,  .mChallengeName = "[SURVIVAL_CUSTOM]" },
	{ .mChallengeMode = GameMode::GAMEMODE_SURVIVAL_CUSTOM_STAGE_9,             .mChallengeIconIndex = 10,  .mPage = ChallengePage::CHALLENGE_PAGE_SURVIVAL_2,  .mRow = 1,  .mCol = 3,  .mChallengeName = "[SURVIVAL_CUSTOM]" },
	{ .mChallengeMode = GameMode::GAMEMODE_SURVIVAL_CUSTOM_STAGE_10,            .mChallengeIconIndex = 10,  .mPage = ChallengePage::CHALLENGE_PAGE_SURVIVAL_2,  .mRow = 1,  .mCol = 4,  .mChallengeName = "[SURVIVAL_CUSTOM]" },
	{ .mChallengeMode = GameMode::GAMEMODE_SURVIVAL_CUSTOM_STAGE_11,            .mChallengeIconIndex = 10,  .mPage = ChallengePage::CHALLENGE_PAGE_SURVIVAL_2,  .mRow = 2,  .mCol = 0,  .mChallengeName = "[SURVIVAL_CUSTOM]" },
	{ .mChallengeMode = GameMode::GAMEMODE_SURVIVAL_CUSTOM_STAGE_12,            .mChallengeIconIndex = 10,  .mPage = ChallengePage::CHALLENGE_PAGE_SURVIVAL_2,  .mRow = 2,  .mCol = 1,  .mChallengeName = "[SURVIVAL_CUSTOM]" },
	{ .mChallengeMode = GameMode::GAMEMODE_SURVIVAL_CUSTOM_STAGE_13,            .mChallengeIconIndex = 10,  .mPage = ChallengePage::CHALLENGE_PAGE_SURVIVAL_2,  .mRow = 2,  .mCol = 2,  .mChallengeName = "[SURVIVAL_CUSTOM]" },
	{ .mChallengeMode = GameMode::GAMEMODE_SURVIVAL_CUSTOM_STAGE_14,            .mChallengeIconIndex = 10,  .mPage = ChallengePage::CHALLENGE_PAGE_SURVIVAL_2,  .mRow = 2,  .mCol = 3,  .mChallengeName = "[SURVIVAL_CUSTOM]" },
	{ .mChallengeMode = GameMode::GAMEMODE_SURVIVAL_CUSTOM_STAGE_15,            .mChallengeIconIndex = 10,  .mPage = ChallengePage::CHALLENGE_PAGE_SURVIVAL_2,  .mRow = 2,  .mCol = 4,  .mChallengeName = "[SURVIVAL_CUSTOM]" },
	{ .mChallengeMode = GameMode::GAMEMODE_CHALLENGE_WAR_AND_PEAS_3,            .mChallengeIconIndex = 0,   .mPage = ChallengePage::CHALLENGE_PAGE_LIMBO,       .mRow = 2,  .mCol = 3,  .mChallengeName = "[WAR_AND_PEAS_3]" },
	{ .mChallengeMode = GameMode::GAMEMODE_CHALLENGE_WAR_AND_PEAS_4,            .mChallengeIconIndex = 0,   .mPage = ChallengePage::CHALLENGE_PAGE_LIMBO,       .mRow = 2,  .mCol = 4,  .mChallengeName = "[WAR_AND_PEAS_4]" },
	{ .mChallengeMode = GameMode::GAMEMODE_CHALLENGE_WALLNUT_BOWLING_4,         .mChallengeIconIndex = 6,   .mPage = ChallengePage::CHALLENGE_PAGE_LIMBO,   	.mRow = 3,  .mCol = 0,  .mChallengeName = "[WALL_NUT_BOWLING_BOSS]" },
};

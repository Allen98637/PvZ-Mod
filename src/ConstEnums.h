...
enum AdviceType : int32_t
{
    ...
    ADVICE_PLANT_NEEDS_PUMPKINSHELL,
    ADVICE_PLANT_ONLY_ON_PUMPKINSHELL,
    NUM_ADVICE_TYPES
};
...
enum ChallengePage : int32_t
{
    ...
    CHALLENGE_PAGE_SURVIVAL_2 = 4,
    MAX_CHALLANGE_PAGES = 5,
    CHALLENGE_PAGE_NONE = -1,
};
...
enum GameMode : int32_t
{
    ...
    GAMEMODE_UPSELL,
    GAMEMODE_INTRO,
    GAMEMODE_CHALLENGE_WALLNUT_BOWLING_3,
    GAMEMODE_CHALLENGE_WHACK_A_ZOMBIE_2,
    GAMEMODE_SURVIVAL_CUSTOM_STAGE_1,
    GAMEMODE_SURVIVAL_CUSTOM_STAGE_2,
    GAMEMODE_SURVIVAL_CUSTOM_STAGE_3,
    GAMEMODE_SURVIVAL_CUSTOM_STAGE_4,
    GAMEMODE_SURVIVAL_CUSTOM_STAGE_5,
    GAMEMODE_SURVIVAL_CUSTOM_STAGE_6,
    GAMEMODE_SURVIVAL_CUSTOM_STAGE_7,
    GAMEMODE_SURVIVAL_CUSTOM_STAGE_8,
    GAMEMODE_SURVIVAL_CUSTOM_STAGE_9,
    GAMEMODE_SURVIVAL_CUSTOM_STAGE_10,
    GAMEMODE_SURVIVAL_CUSTOM_STAGE_11,
    GAMEMODE_SURVIVAL_CUSTOM_STAGE_12,
    GAMEMODE_SURVIVAL_CUSTOM_STAGE_13,
    GAMEMODE_SURVIVAL_CUSTOM_STAGE_14,
    GAMEMODE_SURVIVAL_CUSTOM_STAGE_15,
    GAMEMODE_CHALLENGE_WAR_AND_PEAS_3,
    GAMEMODE_CHALLENGE_WAR_AND_PEAS_4,
    GAMEMODE_CHALLENGE_WALLNUT_BOWLING_4,
    NUM_GAME_MODES
};
...
enum ParticleEffect : int32_t
{
    ...
    PARTICLE_UMBRELLA_REFLECT_CABBAGE,
    PARTICLE_UMBRELLA_REFLECT_KERNEL,
    PARTICLE_UMBRELLA_REFLECT_BUTTER,
    PARTICLE_UMBRELLA_REFLECT_MELON,
    ...
    PARTICLE_UMBRELLA_REFLECT_WINTERMELON2,
    NUM_PARTICLES
};
...
enum ProjectileType : int32_t
{
    ...
    PROJECTILE_ZOMBIE_CABBAGE = 14,
    PROJECTILE_ZOMBIE_MELON = 15,
    PROJECTILE_ZOMBIE_SNOWPEA = 16,
    PROJECTILE_ZOMBIE_WINTERMELON = 17,
    NUM_PROJECTILES = 18
};
...
enum StoreItem : int32_t
{
    ...
    STORE_ITEM_PLANT_PUMPKINSTAIR,
    STORE_ITEM_PLANT_WATERPOT,
